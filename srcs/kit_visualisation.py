...
app.layout = html.Div([
    ...
    html.Div(
        style={"marginBottom": 15, "columnCount": 2},
        children=[
            html.Div([
                html.H3("Visualization of Topic Models for Patent Documents"),
                html.H6("Bachelor Thesis of Paolo Ramella-Ratin")
            ]),
            html.Div(
                ...
                children=[
                    html.A(
                        html.Img(
                            src=app.get_asset_url("econlogo.png"),
                            style={
                                "height": "60px",
                                "width": "auto",
                                "margin-right": "25px",
                        ...
                        href="https://wipo.econ.kit.edu/",
                    ),
    				html.A(
                        html.Img(
                            src=app.get_asset_url("kitlogo.png"),
                            style={
                                "height": "60px",
                                "width": "auto",
                                "margin-right": "25px",
